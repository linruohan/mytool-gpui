...
impl TextView {
    pub fn init(cx: &mut App, focus_handle: &FocusHandle) -> Self {
        let m = Self {
            text: "".to_string(),
            selection: 0..0,
            word_click: (0, 0),
...
impl RenderOnce for TextInput {
    fn render(self, _window: Window, cx: &mut Context<Self>) -> impl IntoElement {
...
impl Render for TextView {
    fn render(&mut self, _window: Window, cx: &mut Context<Self>) -> impl IntoElement {
        let theme = cx.global::<Theme>();
